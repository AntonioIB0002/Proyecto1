...
import { View,Alert, Text,StyleSheet,TextInput, TouchableOpacity, Image} from 'react-native';
import LinearGradient from 'react-native-linear-gradient';
import { NavigationContext } from '@react-navigation/native';

export default class Inicio_contador extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
  ...
  render() {
    ...
    // const inicio_contador = () => {
    //   navigation.navigate('vista del contador');
    // };
    const inicio_contador = () => {
    ...
    return (
        ...
        <LinearGradient colors={['white', '#F8DDCC','black']} style = {styles.Fondo}>
             <View>
                ...
                <TouchableOpacity style = {styles.boton} onPress={inicio_contador}>
